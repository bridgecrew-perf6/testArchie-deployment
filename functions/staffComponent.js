...
exports = function (arg){
 ...
 if (staffData === null || staffData === undefined ) {
      ...
      "sections": [
        {
          "widgets": [
            {
              "textParagraph": {
                  "text": `<font> Couldn't find anyone for "${user.userTyped}", ${firstName}  ${EMOJIS2[0]} </font>`
              }
            }
          ]
        }
  ...
  component.cards = cards;
    ...
    component.text =  `${context.functions.execute("getTextMessage", {type:"staffSearch", userFirstName: firstName})}`;
